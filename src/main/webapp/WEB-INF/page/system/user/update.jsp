...
<form class="layui-form" style="width:80%;">
            ...
            <div class="jq-role-inline">
                <fieldset class="layui-elem-field">
                    ...
                    <div class="layui-field-box">
                        ...
                        <#list roleIds as roleId><#if (roleId == role.id)>checked
                    </
                    #if>
                </
                #list> />
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="checkbox" name="delFlag" lay-skin="switch" value="true" lay-text="启用|停用" <#if
            (localuser.delFlag == false)>checked=""
        </
        #if> >
    </div>
    </div>
