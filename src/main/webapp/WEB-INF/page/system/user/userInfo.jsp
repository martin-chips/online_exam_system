...
<form class="layui-form">
    <div class="user_left">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="${userinfo.loginName}" name="loginName" disabled
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="tel" value="${userinfo.tel}" name="tel" placeholder="请输入手机号码" lay-verify="phone"
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" value="${userinfo.email}" name="email" placeholder="请输入邮箱" lay-verify="email"
    ...
    <div class="user_right">
        ...
        <img <#if (userinfo.icon??)>src="${userinfo.icon}" <#else> src="${base}/static/images/face.jpg "
    </
    #if> class="layui-circle" id="userFace">
    </div>
